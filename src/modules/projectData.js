module.exports = {
  ...
  "soloProjects": [
    {
      "name": 'Star Calc',
      "summary": 'Calculator created from HTML/CSS/JS.'
    },
    {
      "name": 'Star Date',
      "summary": 'A calendar made from HTML/JavaScript/SASS'
    },
    {
      "name": 'Game of Last Words',
      "summary": 'A web application that randomly generates the last words of characters from the HBO series Game of Thrones'
    },
    {
      "name": 'Pomodoro Timer',
